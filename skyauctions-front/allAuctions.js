...
class AllAuctionModel {
    ...
    loadAuctions(page=1, bin="", tier="", type="", itemName=""){
        var connectString = "http://127.0.0.1:8000/api/auction/?page="+page;
        if (bin === ""){
            bin = "Any";
        } else if (bin === "Yes"){
            bin = "True";
  ...
  class AllAuctionView {
    constructor() {
        ...
        this.title.textContent = 'All Auctions'
  ...
  const app = new AllAuctionController(new AllAuctionModel(), new AllAuctionView())
